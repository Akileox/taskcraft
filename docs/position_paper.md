...
## References (auto)
- [Act with Intent: Distilling Behavior Intent for Vision-Language-Action Models](docs/research_notes/23_act-with-intent-distilling-behavior-intent-for-vision-language-action-models.md) — 2026-09-01 자동 수집
